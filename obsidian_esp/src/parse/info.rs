...
pub fn parse_info_file<'s>(input: &mut &'s str) -> Result<(ParsedInfoFrontmatter, String)> {
        ...
        take_till::<_, &'s str, ContextError>(1.., ['\n', '\r']).parse_peek(*input)
    {
        ...
        dispatch_yaml_field(key_str.trim(), val_opt, &mut info, &mut filters_map);
    }
...
/// and complex field types like `DialogueType2` and `Sex`.
fn dispatch_yaml_field(
    key: &str,
    val_opt: Option<String>,
    info: &mut ParsedInfoFrontmatter,
    filters_map: &mut BTreeMap<u8, (Option<FilterType>, Option<String>)>,
) {
            ...
            if let Some(val) = val_opt {
                let ftype = alt::<_, _, ContextError, _>((
                    ...
                    alt::<_, _, ContextError, _>((
                        alt::<_, _, ContextError, _>((Caseless("NotId"), Caseless("Not ID")))
                        ...
                        alt::<_, _, ContextError, _>((Caseless("NotClass"), Caseless("Not Class")))
                            .value(FilterType::NotClass),
                        alt::<_, _, ContextError, _>((Caseless("NotRace"), Caseless("Not Race")))
                            .value(FilterType::NotRace),
                        alt::<_, _, ContextError, _>((Caseless("NotCell"), Caseless("Not Cell")))
                            .value(FilterType::NotCell),
                        alt::<_, _, ContextError, _>((Caseless("NotLocal"), Caseless("Not Local")))
